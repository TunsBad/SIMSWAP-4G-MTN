...
$(function () {
    ...
    $("#btnFilter").click(function () {
        ...
        var filteredSubscribersDataSource = {
            transport: {
                read: {
                    url: Ap + "Subscriber/GetAllSyncedSubscribersByDate",
                    type: 'Post',
...
var oUI = (function () {
    ...
    oUI.prototype.renderAsetGrid = function () {
        ...
        renderGrid(PendingRequestsDataSource);
    }

    return oUI;
})();

var PendingRequestsDataSource = {
    transport: {
        read: {
            url: Api + "/GetFulfilledRequests",
            type: 'Post',
            contentType: "application/json",
        },
        parameterMap: function (data, type) {
...
function renderGrid(dataSource) {
    $("#fulfilledrequestsGrid").kendoGrid({
        pdfExport: onPdfExport,
        dataSource: dataSource,
        toolbar: ["excel", "pdf"],
        excel: {
            fileName: "Pending Requests.xlsx",
