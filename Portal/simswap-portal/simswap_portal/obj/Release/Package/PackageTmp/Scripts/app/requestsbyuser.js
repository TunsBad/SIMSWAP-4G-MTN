...
$(function () {
    ...
    $("#btnFilter").click(function () {
        ...
        var filteredSubscribersDataSource = {
            transport: {
                read: {
                    url: Api_Root + "Subscriber/GetAllSyncedSubscribersByDate",
                    type: 'Post',
...
//        renderGrid(AllSubscribersDataSource);
//    }
...
var RequestsDataSource = {
    transport: {
        read: {
            url: Api + "/GetSimSwapRequestsByUser?userid=" + userid,
            type: 'Post',
            contentType: "application/json",
        },
        parameterMap: function (data, type) {
    ...
    schema: {
        ...
        model: {
            ...
            fields: {
                ...
                DateSubmitted: { editabl: false, type: 'date' },
...
function renderGrid(dataSource) {
    $("#requestsbyuserGrid").kendoGrid({
        pdfExport: onPdfExport,
        dataSource: dataSource,
        toolbar: ["excel", "pdf"],
        excel: {
            fileName: "SimSwap Requests Made By One User.xlsx",
        ...
        pdf: {
            ...
            avoidLinks: true,
            proxyURL: "/Home/Excel_Export_Save",
            fileName: "SimSwap Request Made By One User.pdf",
            margin: {
            },
        },
        columns: [
